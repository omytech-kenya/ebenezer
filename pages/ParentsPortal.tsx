    ...
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center text-white">
          <Reveal direction="up">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Parents Portal</h1>
            <p className="mt-3 text-lg md:text-xl text-gray-200">Sign in or create your account with your name and your child’s registration number.</p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto w-full max-w-xl">
          ...
          <Reveal delayMs={120}>
            <form onSubmit={handleSubmit} className="space-y-5 rounded-2xl bg-white p-6 ring-1 ring-black/5 shadow-sm">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-secondary-navy mb-1">Parent/Guardian Name</label>
                <input
                  id="name"
                  name="name"
                  type="text"
              ...
              <div>
                <label htmlFor="regno" className="block text-sm font-medium text-secondary-navy mb-1">Student Registration Number (Password)</label>
                <input
                  id="regno"
                  name="regno"
                  type="text"
